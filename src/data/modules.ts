...
export const modules: Module[] = [
  ...
  {
    id: 3,
    title: 'Agentes, Automatización y Prototipado Legaltech',
    subtitle: 'Construye criterio antes de automatizar. Luego automatiza.',
    date: '2026-09-22',
    ...
    duration: '2 horas',
    objectives: [
      'Comprender la arquitectura de agentes de IA y GPTs jurídicos',
      'Construir system prompts para agentes especializados en derecho',
      'Prototizar herramientas legaltech simples con GitHub y Vercel',
      'Evaluar riesgos éticos, de datos y de responsabilidad profesional',
    ],
    contents: [
      'GPTs y agentes jurídicos: arquitectura, límites y casos de uso reales',
      'System prompts de producción: construye tu agente jurídico',
      'Claude Projects y Model Context Protocol (MCP): el futuro de los agentes',
      'GitHub + Vercel: prototipa una herramienta legaltech en vivo',
      'Riesgos éticos y de datos personales en legaltech',
      'El abogado del futuro: Harvey AI, Clio, Thomson Reuters AI',
    ],
    tools: ['Claude', 'ChatGPT', 'GitHub', 'Vercel'],
    activity: 'Hackathon de cierre: equipos diseñan, construyen y presentan un prototipo legaltech usando las herramientas del programa.',
    deliverable: 'Prototipo legaltech: problema jurídico identificado + solución con IA + demo funcional o flujo documentado',
    participants: 0,
    timeline: [
      ...
      { time: '0:20–0:45', topic: 'Construye tu agente jurídico', type: 'workshop', description: 'System prompt de Claude Project o GPT personalizado. Cada participante construye el suyo.' },
      { time: '0:45–1:10', topic: 'GitHub y Vercel para prototipos', type: 'practice', description: 'Repositorio, deploy y publicación de una herramienta legaltech simple.' },
      { time: '1:10–1:30', topic: 'Legaltech aplicada', type: 'demo', description: 'Harvey AI, Clio, Thomson Reuters AI. El ecosistema que ya existe.' },
      { time: '1:30–1:50', topic: 'Ética, datos y responsabilidad', type: 'analysis', description: 'Riesgos reales del abogado que usa IA. Dónde está el límite.' },
      { time: '1:50–2:00', topic: 'Cierre del programa', type: 'closing', description: 'El futuro profesional. Certificación. Comunidad DIAT.' },
    ],
  },
];
